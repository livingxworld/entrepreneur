...
[begins tags="div" class="row text-center" /]
	[begins tags="div" class="col col-12 col-md-6" /]
		...
		[begins tags="div" class="card text-white bg-" /]
			[lxw-badge parent="logiciels" category="developpement/logiciels" entreprise="" css="card-img-top img-fluid rounded mx-auto d-block img-thumbnail border border-" showembed="yes" /]
