...
[begins tags="div" class="row text-center" /]
	[begins tags="div" class="col col-12 col-md-6" /]
		...
		[begins tags="div" class="card text-white bg-" /]
			[lxw-badge parent="logement" category="coworking" entreprise="la-cordee" css="card-img-top img-fluid rounded mx-auto d-block img-thumbnail border border-" showembed="yes" /]
