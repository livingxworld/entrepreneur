<p>[img src="https://business.livingxworld.com/images/jcb.png" alt="jcb" style="display: block; margin-left: auto; margin-right: auto; width: 300px; height: 300px;" /]</p>
<hr id="system-readmore" />

<h2 style="text-align: center;"><span style="text-decoration: underline;"><strong>Présentation</strong></span></h2>

 <p><strong>Description:</strong> Il s'agit du site Web de JCB, la seule marque de paiement internationale du Japon. Nous disposons d'une variété de services utiles et d'informations pour les membres de la carte JCB et les partenaires de la marque JCB.</p>

[youtube source="ybfjeUqIeWM" /]
...
[begins tags="div" class="row text-center" /]
	[begins tags="div" class="col-xs-12 col-md-6" /]
		[h3]Badge[/h3]
		[lxw-badge parent="administration" category="bank/label" entreprise="jcb" showembed="yes" /]
	...
	[begins tags="div" class="col-xs-12 col-md-6" /]
		...
		[begins tags="blockquote" /] 
			...
			[begins tags="dl" class="dl-horizontal" /] 
				...
				[begins tags="dd" /][fa name="ban" /] imcomplet[ends tags="dd" /] 
			[ends tags="dl" /] 
...
[begins tags='script' more='type="application/ld+json"' /] 
	{
		...
		"logo": "https://business.livingxworld.com/images/jcb.png",
		"description": "Il s'agit du site Web de JCB, la seule marque de paiement internationale du Japon. Nous disposons d'une variété de services utiles et d'informations pour les membres de la carte JCB et les partenaires de la marque JCB.",
		"review": {
			"@type": "Review",
