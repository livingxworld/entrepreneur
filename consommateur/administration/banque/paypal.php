...
<h2 style="text-align: center;"><span style="text-decoration: underline;"><strong>Présentation</strong></span></h2>
 ...
 <p><strong>Description:</strong> Faites vos achats en ligne sans saisir vos coordonnées bancaires, acceptez les paiements par carte ou compte PayPal et envoyez facilement de l’argent.</p>
	...
	[begins tags="div" class="col-xs-12 col-md-6" /]
		...
		[lxw-badge parent="administration" category="bank" entreprise="paypal" showembed="yes" /]
			...
			[begins tags="dl" class="dl-horizontal" /] 
				...
				[begins tags="dd" /]  	DigiCert SHA2 High Assurance Server CA : C (non sécurisé doit faire mieux A+)| à corriger RC4 cipher, 64-bit block cipher (3DES / DES / RC2 / IDEA) et Forward Secrecy [ends tags="dd" /] 
			[ends tags="dl" /] 
	[ends tags="div" /]	
	[begins tags="div" class="col-xs-12 col-md-6" /]
...
[begins tags='script' more='type="application/ld+json"' /] 
	{
		...
		"description": "Faites vos achats en ligne sans saisir vos coordonnées bancaires, acceptez les paiements par carte ou compte PayPal et envoyez facilement de l’argent.",
