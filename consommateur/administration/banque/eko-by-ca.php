<p>[img src="https://business.livingxworld.com/images/eko-by-ca.jpg" alt="eko by ca (crédit agricole)" style="display: block; margin-left: auto; margin-right: auto; width: 300px; height: 300px;" /]</p>
<hr id="system-readmore" />

<h2 style="text-align: center;"><span style="text-decoration: underline;"><strong>Présentation</strong></span></h2>

 <p><strong>Description:</strong> L'offre eko: votre carte mastercard internationale à contrôle de solde pour maîtriser votre budget et éviter le découvert.</p>
	...
	[begins tags="div" class="col-xs-12 col-md-6" /]
		...
		[lxw-badge parent="administration" category="bank" entreprise="eko-by-ca" showembed="yes" /]
			...
			[begins tags="dl" class="dl-horizontal" /] 
				...
				[begins tags="dd" /]CLASS 2 KEYNECTIS CA : A- (non sécurisé doit faire mieux A+) | à corriger Forward Secrecy[ends tags="dd" /] 
			[ends tags="dl" /] 
	[ends tags="div" /]	
	[begins tags="div" class="col-xs-12 col-md-6" /]
...
[begins tags='script' more='type="application/ld+json"' /] 
	{
		...
		"description": "L'offre eko: votre carte mastercard internationale à contrôle de solde pour maîtriser votre budget et éviter le découvert.",
