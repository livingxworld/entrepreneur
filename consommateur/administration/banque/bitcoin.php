...
<h2 style="text-align: center;"><span style="text-decoration: underline;"><strong>Présentation</strong></span></h2>
 ...
 <p><strong>Description:</strong> "Bitcoin est un réseau de paiement novateur et une nouvelle forme d'argent. Trouvez tout ce que vous devez savoir et débutez avec Bitcoin sur bitcoin.org.</p>
	...
	[begins tags="div" class="col-xs-12 col-md-6" /]
		...
		[lxw-badge parent="administration" category="bank" entreprise="bitcoin" showembed="yes" /]
			...
			[begins tags="dl" class="dl-horizontal" /] 
				...
				[begins tags="dd" /]  	COMODO RSA Domain Validation Secure Server CA : oui[ends tags="dd" /] 
			[ends tags="dl" /] 
	[ends tags="div" /]	
	[begins tags="div" class="col-xs-12 col-md-6" /]
...
[begins tags='script' more='type="application/ld+json"' /] 
	{
		...
		"description": ""Bitcoin est un réseau de paiement novateur et une nouvelle forme d'argent. Trouvez tout ce que vous devez savoir et débutez avec Bitcoin sur bitcoin.org.",
		"review": {
			"@type": "Review",
