<p>[img src="https://business.livingxworld.com/images/carte-zero.png" alt="carte zero" style="display: block; margin-left: auto; margin-right: auto; width: 300px; height: 300px;" /]</p>
<hr id="system-readmore" />

<h2 style="text-align: center;"><span style="text-decoration: underline;"><strong>Présentation</strong></span></h2>

 <p><strong>Description:</strong>ZERO Card - Order FREE your ZERO Card now! Zero Purchase Charge, Zero Dividend, Credit included</p>
...
[begins tags="div" class="row" /]
	[begins tags="div" class="col-xs-12 col-md-4" /]
		[h3]coordinated[/h3]
		[fa name="external-link" zoom="2x" /] [a href="//cartezero.fr" target="_blank"]Site internet[/a] [br /]
		[fa name="map-marker" zoom="2x" /] 9, rue Gabriel Lippmann, L-5365 Munsbach, Luxembourg [br /]
		[fa name="phone" zoom="2x" /] none [br /]
	[ends tags="div" /]	
	[begins tags="div" class="col-xs-12 col-md-8" /]
		[h3]map[/h3]
		[mapbox-custom parent="administration" category="bank" entreprise="carte-zero" /]
...
[begins tags="div" class="row text-center" /]
	[begins tags="div" class="col-xs-12 col-md-6" /]
		[h3]Badge[/h3]
		[lxw-badge parent="administration" category="bank" entreprise="carte-zero" showembed="yes" /]
...
[begins tags='script' more='type="application/ld+json"' /] 
	{
		...
		"logo": "https://business.livingxworld.com/images/carte-zero.png",
		"description": "Carte ZERO - Commandez GRATUITEMENT votre Carte ZERO d&egrave;s maintenant ! Z&eacute;ro Frais &agrave; l'Achat, Z&eacute;ro Cotisation, Cr&eacute;dit inclus",
		"address": {
			"@type": "PostalAddress",
			"streetAddress": "9, rue Gabriel Lippmann, L-5365 Munsbach, Luxembourg"
		},
