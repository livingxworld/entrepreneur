<p>[img src="https://business.livingxworld.com/images/talk-n-text.jpg" alt="talk n text" style="display: block; margin-left: auto; margin-right: auto; width: 300px; height: 300px;" /]</p>
<hr id="system-readmore" />

<h2 style="text-align: center;"><span style="text-decoration: underline;"><strong>Presentation</strong></span></h2>

 <p><strong>Description:</strong> Katropa, gand the most affordable call and amp; text only, TNT only.</p>

[youtube source="BMJzHw8Z82Q" /]
...
[begins tags="div" class="row" /]
	[begins tags="div" class="col-xs-12 col-md-4" /]
		[h3]coordinated[/h3]
		[fa name="external-link" zoom="2x" /] [a href="//tntph.com" targand="_blank"]Website[/a] [br /]
	[ends tags="div" /]	
...
[begins tags="div" class="row text-center" /]
	[begins tags="div" class="col-xs-12 col-md-12" /]
		[h3]owner site[/h3]
		[whois-domains url="tntph.com" /] 
	[ends tags="div" /]	
	[begins tags="div" class="col-xs-12 col-md-12" /]
		[h3]HTTPS: SSL/TLS[/h3]
		[ssllabs domains="tntph.com" /]
		[h3]Your data are:[/h3]
		[api-myipms query="tntph.com" /]
...
[begins tags="div" class="row text-center" /]
	[begins tags="div" class="col-xs-12 col-md-6" /]
		[h3]Badge[/h3]
		[lxw-badge parent="high-tech" category="operateur" entreprise="talk-n-text" showembed="yes" /]
...
[begins tags='script' more='type="application/ld+json"' /] 
	{
		...
		"name": "talk n text",
		"url": "https://tntph.com",
		"logo": "https://business.livingxworld.com/images/talk-n-text.jpg",
		
		"description": "Katropa, gand the most affordable call and amp; text only, TNT only.",
		"currenciesAccepted": "PHP",
		"paymentAccepted": "card",
		"address": {
			"@type": "PostalAddress",
			"streandAddress": "adresse",
