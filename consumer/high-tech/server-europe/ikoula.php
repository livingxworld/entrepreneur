<p>[img src="https://business.livingxworld.com/images/ikoula.png" alt="ikoula" style="display: block; margin-left: auto; margin-right: auto; width: 300px; height: 300px;" /]</p>
<hr id="system-readmore" />

<h2 style="text-align: center;"><span style="text-decoration: underline;"><strong>Presentation</strong></span></h2>

 <p><strong>Description:</strong> Ikoula, web hosting since 1998 offers web hosting, dedicated server, VPS, domain name, cloud, SSL, messaging, backup and storage.</p>
...
[begins tags="div" class="row" /]
	...
	[begins tags="div" class="col-xs-12 col-md-8" /]
		[h3]map[/h3]
		[mapbox-custom parent="high-tech" category="server-europe" entreprise="ikoula" /]
...
[begins tags="div" class="row text-center" /]
	[begins tags="div" class="col-xs-12 col-md-12" /]
		[h3]owner site[/h3]
		[whois-domains url="ikoula.com" /] 
	[ends tags="div" /]	
	[begins tags="div" class="col-xs-12 col-md-12" /]
		[h3]HTTPS: SSL/TLS[/h3]
		[ssllabs domains="ikoula.com" /]
		[h3]Your data are:[/h3]
		[api-myipms query="ikoula.com" /]
...
[begins tags="div" class="row text-center" /]
	[begins tags="div" class="col-xs-12 col-md-6" /]
		[h3]Badge[/h3]
		[lxw-badge parent="high-tech" category="server/europeen" entreprise="ikoula" showembed="yes" /]
			...
			[begins tags="dl" class="dl-horizontal" /] 
				...
				[begins tags="dd" /] GeoTrust EV SSL CA - G4 : yes (Secure can do better A+)[ends tags="dd" /] 
			[ends tags="dl" /] 
	[ends tags="div" /]	
	[begins tags="div" class="col-xs-12 col-md-6" /]
...
[begins tags='script' more='type="application/ld+json"' /] 
	{
		...
		"description": "Ikoula, web hosting since 1998 offers web hosting, dedicated server, VPS, domain name, cloud, SSL, messaging, backup and storage.",
